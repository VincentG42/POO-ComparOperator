...
<body>
    <header class="w-full bg-slate-600 flex justify-around py-5">
        <img src="./img/imgs_diverses/plane.png" alt="logo avion">
        <h1 class="w-max text-center text-emerald-600 text-5xl font-extrabolditems-center">TOUR OPERATOR</h1>
        <div>
            <form class="max-w-md mx-auto flex gap-2 items-center" action ="./process/connect_process.php" method="post">
                ...
                <button type="submit" class="text-white bg-emerald-700 hover:bg-emerald-800 h-8 focus:ring-4 focus:outline-none focus:ring-emerald-300 font-small rounded-lg text-sm w-full sm:w-auto px-3 py-1 text-center dark:bg-blue-600">Submit</button>
            </form>
        </div>
