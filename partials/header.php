    ...
    <header class="w-full bg-slate-600 flex justify-around py-5">
        ...
        <div>
            <form class="max-w-md mx-auto flex gap-2 items-center" action ="./process/connect_process.php" method="post">
                ...
                <button type="submit" class="text-white bg-teal-300 hover:bg-teal-800 h-8 focus:ring-4 focus:outline-none focus:ring-teal-300 font-small rounded-lg text-sm w-full sm:w-auto px-3 py-1 text-center dark:bg-blue-600">Submit</button>
            </form>
        </div>
