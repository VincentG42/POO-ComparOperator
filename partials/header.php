...
<body>
    <header class="w-full bg-slate-600 flex flex-col lg:flex-row justify-between flex-wrap px-5 py-2 items-center-5">
        <a href="./index.php"><img src="./img/imgs_diverses/logo.png" alt="logo "></a>
        <h1 class=" text-center text-teal-300 text-8xl"> Horizons Infinis</h1>
        <div class='flex items-center'>
            <form class="flex gap-2 items-center" action ="./process/connect_process.php" method="post">
                <div class="relative z-0 w-full mb-5 group">
                    <input type="pseudo" name="floating_pseudo" id="floating_pseudo" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-teal-300 peer" placeholder="Pseudo " required />
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input type="password" name="floating_password" id="floating_password" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-teal-300" placeholder="Password " required />
